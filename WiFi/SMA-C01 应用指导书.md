...
             本手册介绍了SMA-C01应用指导书产品参数，包含以下章节。 

| 章     | **标题**     | **内容**                         |
| :----- | :----------- | :------------------------------- |
| 第一章 | 产品简介     | 概述SMA-C01的特点和功能应用      |
...
               SMA-C01是深圳酷宅科技有限公司（简称：酷宅科技）一款基于 ESP8285 的超低功耗的Wi-Fi单通道开关模
...
        SMA-C01可广泛应用于智能电网、智能交通、智能家具、手持设备、工业控制等领域。
...
                               SMA-C01模块提供单通道开关控制接口，Wi-Fi指示灯接口，UART串口。
...
            SMA-C01模块可作为一个单通道的开关设备，既可以在本地控制开关，也可以通过APP远程控制开关。以
...
2. 定时：包括单次定时、延时定时、循环定时及重复定时，具体说明见4.5。

3. 上电状态配置：可通过APP端配置上电开关状态开或是关，默认上电关。
...
            SMA-C01支持定时器操作，为了方便客户使用以及让其使用在更多的场景下，易微联APP提供了四种定时
